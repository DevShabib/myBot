...
const Demo: React.FC = () => {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center font-abc-repro font-normal text-sm text-red-500 p-8">
      <SimliHeaderLogo />
      <Navbar />
      ...
      <div className="absolute top-[32px] right-[32px]">
        <text
          ...
          className="font-bold cursor-pointer mb-8 text-xl leading-8 text-red-500 hover:text-red-400"
        >
          <Image className="w-[20px] inline mr-2" src={GitHubLogo} alt="" />
          create-simli-agent
        </text>
      </div>
      <div className="flex flex-col items-center gap-6 bg-red-900/50 p-6 pb-[40px] rounded-xl w-full border-2 border-red-500">
        <div className="flex flex-col items-center gap-4 border-t-2 border-b-2 border-red-500 pt-4 pb-4">
      ...
      <div className="max-w-[350px] font-thin flex flex-col items-center text-white">
          <span className="font-bold mb-[8px] leading-5 text-center text-red-500">
          {" "}
        ...
        <div className="max-w-[350px] mt-2">
          <div className="mb-1">
            <a href="https://x.com/RickyAgent822" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
              <span className="text-white">Follow on Twitter</span>
